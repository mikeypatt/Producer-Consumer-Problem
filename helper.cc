...
int sem_timedwait(int id,short unsigned int num,int time_limit)
{
  struct sembuf op[] = {
    {num, -1, SEM_UNDO}
  };
  ...
  time_struct.tv_sec = time_limit ;      /* Seconds */
  time_struct.tv_nsec = 0;     /* Nanoseconds [0 .. 999999999] */
  
  if(semtimedop(id,op,1,&time_struct) < 0)
  {
      return -1 ;
  }
  return 0 ;
